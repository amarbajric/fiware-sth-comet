 ...
 */
function getMultiAttributesContextElement(entityId, entityType, attributes) {
    return {
        contextElement: {
 ...
 */
function getSingleAttributeResult(attrName, fields, values) {
    return {
        name: attrName,
        fields: fields,
        values: values
 ...
 */
function getSingleNonNGSIResult(entityId, entityType, attributes) {
    return {
        entityId: entityId,
 ...
 */
function getNonNGSIFormatPayload(results) {
    return {
        results: results
    };
}
...
module.exports = {
    ...
    getMultiAttributesContextElement: getMultiAttributesContextElement,
    getNGSIMultiContextElementsPayload: getNGSIMultiContextElementsPayload,
    getSingleAttributeResult: getSingleAttributeResult,
    getSingleNonNGSIResult: getSingleNonNGSIResult,
    getNonNGSIFormatPayload: getNonNGSIFormatPayload
};
