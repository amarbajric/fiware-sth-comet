      ...
      config: {
        validate: {
          ...
          query: {
            ...
            aggrMethod: joi.string().valid('max', 'min', 'sum', 'sum2', 'occur', 'avg').optional(),
            aggrPeriod: joi.string().required().valid('month', 'week', 'day', 'hour', 'halfhour', 'quarterhour',
                'minute', 'second').optional(),
