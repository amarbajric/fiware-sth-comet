...
function getAvgAggregationData(data, callback) {
    var collection = data.collection,
        entityId = data.entityId,
        entityType = data.entityType,
        attrName = data.attrName,
    ...
    var totalCount, batchSize, acc, id;
    var cursor = collection.find(findCondition);
    cursor.count(function(err, count) {
        totalCount = count;
        ...
        var options = {
            ...
            scope: {
                ...
                acc: acc,
                limitPx: hLimit,
                sizeDataset: totalCount,
                batchSize: (totalCount/hLimit) << 0
            },
        }

        var coll = data.collection;
        coll.mapReduce(mapFunction,reduceFunction,options,function(err, results) {
...
module.exports = {
  ...
  getAvgAggregationData: getAvgAggregationData,
